 ...
 */
function(){me.event=function(){var a={},b={};return a.STATE_PAUSE="me.state.onPause",a.STATE_RESUME="me.state.onResume",a.STATE_STOP="me.state.onStop",a.STATE_RESTART="me.state.onRestart",a.GAME_INIT="me.game.onInit",a.LEVEL_LOADED="me.game.onLevelLoaded",a.LOADER_COMPLETE="me.loader.onload",a.LOADER_PROGRESS="me.loader.onProgress",a.KEYDOWN="me.input.keydown",a.KEYUP="me.input.keyup",a.WINDOW_ONRESIZE="window.onresize",a.WINDOW_ONORIENTATION_CHANGE="window.orientationchange",a.WINDOW_ONSCROLL="window.onscroll",a.VIEWPORT_ONCHANGE="viewport.onchange",a.publish=function(a,c){for(var d=b[a],e=d?d.length:0;e--;)d[e].apply(window,c||[])},a.subscribe=function(a,c){return b[a]||(b[a]=[]),b[a].push(c),[a,c]},a.unsubscribe=function(a,c){var d=b[c?a:a[0]],e=d?d.length:0;for(c=c||a[1];e--;)d[e]===c&&d.splice(e,1)},a}()}(),function(){me.plugin=function(){var a={};return a.Base=Object.extend({version:void 0,init:function(){}}),a.patch=function(a,b,c){if(void 0!==a.prototype&&(a=a.prototype),"function"==typeof a[b]){var d=a[b];a[b]=function(a,b){return function(){var a=this.parent;this.parent=d;var c=b.apply(this,arguments);return this.parent=a,c}}(b,c)}else console.error(b+" is not an existing function")},a.register=function(a,b){if(me.plugin[b]&&console.error("plugin "+b+" already registered"),void 0===a.prototype.version)throw"melonJS: Plugin version not defined !";if(me.sys.checkVersion(a.prototype.version)>0)throw"melonJS: Plugin version mismatch, expected: "+a.prototype.version+", got: "+me.version;var c=[];if(arguments.length>2&&(c=Array.prototype.slice.call(arguments,1)),c[0]=a,me.plugin[b]=new(a.bind.apply(a,c)),!(me.plugin[b]instanceof me.plugin.Base))throw"melonJS: Plugin should extend the me.plugin.Base Class !"},a}()}(),function(){me.debug=me.debug||{},debugPanel=me.plugin.Base.extend({GUID:null,area:{},rect:null,z:1/0,visible:!1,version:"0.9.9",init:function(a,b){this.parent(),this.rect=new me.Rect(new me.Vector2d(0,0),me.video.getWidth(),35),this.GUID="debug-"+me.utils.createGUID(),this.name="me.debugPanel",this.isPersistent=!0,this.floating=!0,this.isRenderable=!0,this.alwaysUpdate=!0,this.font=new me.Font("courier",10,"white"),this.area.renderHitBox=new me.Rect(new me.Vector2d(160,5),15,15),this.area.renderVelocity=new me.Rect(new me.Vector2d(165,18),15,15),this.area.renderDirty=new me.Rect(new me.Vector2d(270,5),15,15),this.area.renderCollisionMap=new me.Rect(new me.Vector2d(270,18),15,15),this.help_str="(s)how/(h)ide",this.help_str_len=this.font.measureText(me.video.getSystemContext(),this.help_str).width,this.fps_str_len=this.font.measureText(me.video.getSystemContext(),"00/00 fps").width,me.debug.displayFPS=!0,me.input.bindKey(a||me.input.KEY.S,"show"),me.input.bindKey(b||me.input.KEY.H,"hide"),this.samples=[],this.patchSystemFn(),this.show()},patchSystemFn:function(){me.debug.renderHitBox=me.debug.renderHitBox||!1,me.debug.renderVelocity=me.debug.renderVelocity||!1,me.plugin.patch(me.timer,"update",function(){this.parent(),me.timer.countFPS()}),me.plugin.patch(me.SpriteObject,"draw",function(a){this.parent(a),me.debug.renderHitBox&&(a.strokeStyle="green",a.strokeRect(this.left,this.top,this.width,this.height))}),me.plugin.patch(me.ObjectEntity,"draw",function(a){if(this.parent(a),me.debug.renderHitBox&&this.shapes.length&&(this.collisionBox.draw(a,"red"),"Rectangle"!==this.shapes[0].shapeType&&(a.translate(this.pos.x,this.pos.y),this.shapes[0].draw(a,"red"),a.translate(-this.pos.x,-this.pos.y))),me.debug.renderVelocity){var b=~~(this.pos.x+this.hWidth),c=~~(this.pos.y+this.hHeight);a.strokeStyle="blue",a.lineWidth=1,a.beginPath(),a.moveTo(b,c),a.lineTo(b+~~(this.vel.x*this.hWidth),c+~~(this.vel.y*this.hHeight)),a.stroke()}})},show:function(){this.visible||(me.game.getEntityByName("me.debugPanel")[0]||(me.game.add(this,this.z),me.game.sort()),me.input.registerPointerEvent("mousedown",this.rect,this.onClick.bind(this),!0),this.visible=!0,me.game.repaint())},hide:function(){this.visible&&(me.input.releasePointerEvent("mousedown",this.rect),this.visible=!1,me.game.repaint())},update:function(){return me.input.isKeyPressed("show")?this.show():me.input.isKeyPressed("hide")&&this.hide(),!0},getRect:function(){return this.rect},onClick:function(a){this.area.renderHitBox.containsPoint(a.gameX,a.gameY)?me.debug.renderHitBox=!me.debug.renderHitBox:this.area.renderCollisionMap.containsPoint(a.gameX,a.gameY)?me.debug.renderCollisionMap=!me.debug.renderCollisionMap:this.area.renderVelocity.containsPoint(a.gameX,a.gameY)&&(me.debug.renderVelocity=!me.debug.renderVelocity),me.game.repaint()},drawMemoryGraph:function(a,b,c){if(window.performance&&window.performance.memory){var d=Number.prototype.round(window.performance.memory.usedJSHeapSize/1048576,2),e=Number.prototype.round(window.performance.memory.totalJSHeapSize/1048576,2),f=c-b;this.samples.shift(),this.samples[f]=d/e*25;for(var g=f;g--;){var h=c-(f-g);a.beginPath(),a.strokeStyle="lightgreen",a.moveTo(h,30),a.lineTo(h,30-(this.samples[g]||0)),a.stroke()}this.font.draw(a,d+"/"+e+" MB",b,18)}else this.font.draw(a,"??/?? MB",b,18)},draw:function(a){a.save(),a.globalAlpha=.5,a.fillStyle="black",a.fillRect(this.rect.left,this.rect.top,this.rect.width,this.rect.height),a.globalAlpha=1,this.font.draw(a,"#objects : "+me.game.world.children.length,5,5),this.font.draw(a,"#draws   : "+me.game.world.drawCount,5,18),this.font.draw(a,"?hitbox   ["+(me.debug.renderHitBox?"x":" ")+"]",100,5),this.font.draw(a,"?velocity ["+(me.debug.renderVelocity?"x":" ")+"]",100,18),this.font.draw(a,"?dirtyRect  [ ]",200,5),this.font.draw(a,"?col. layer ["+(me.debug.renderCollisionMap?"x":" ")+"]",200,18),this.drawMemoryGraph(a,300,this.rect.width-this.help_str_len-5),this.font.draw(a,this.help_str,this.rect.width-this.help_str_len-5,18);var b=""+me.timer.fps+"/"+me.sys.fps+" fps";this.font.draw(a,b,this.rect.width-this.fps_str_len-5,5),a.restore()},onDestroyEvent:function(){this.hide(),me.input.unbindKey(me.input.KEY.S),me.input.unbindKey(me.input.KEY.H)}})}(window);var game={data:{score:0},onload:function(){return me.video.init("screen",480,640,!0,"auto")?("#debug"===document.location.hash&&window.onReady(function(){me.plugin.register.defer(debugPanel,"debug")}),me.audio.init("mp3,ogg"),me.loader.onload=this.loaded.bind(this),me.loader.preload(game.resources),void me.state.change(me.state.LOADING)):void alert("Your browser does not support HTML5 canvas.")},loaded:function(){me.entityPool.add("theMan",game.ManEntity),me.entityPool.add("badguy1",game.Badguy1Entity),me.entityPool.add("face",game.FaceEntity),me.state.set(me.state.MENU,new game.TitleScreen),me.state.set(me.state.PLAY,new game.PlayScreen),me.state.set(me.state.GAMEOVER,new game.GameOverScreen),me.state.set(me.state.GAME_END,new game.GameEndScreen),me.input.bindKey(me.input.KEY.SPACE,"start"),me.input.bindKey(me.input.KEY.A,"left"),me.input.bindKey(me.input.KEY.D,"right"),me.input.bindKey(me.input.KEY.W,"up"),me.input.bindKey(me.input.KEY.S,"down"),me.input.bindKey(me.input.KEY.LEFT,"shootLeft"),me.input.bindKey(me.input.KEY.RIGHT,"shootRight"),me.input.bindKey(me.input.KEY.UP,"shootUp"),me.input.bindKey(me.input.KEY.DOWN,"shootDown"),me.sys.gravity=0,me.state.change(me.state.MENU)},worries:["You don't really understand this stuff","No one likes you","Your fly might be open","That man is staring at you","You might have a bogey","Don't look bored","I'm really tired","You need exercise","Don't fail","You need to succeed","Don't be like you are","You're doing it wrong","You're sweating","Everyone can smell your feet","You're not listening!","Eat your five a day","RSI will ruin your life","Did I lock the front door?","Forgot that person's name","I'll never be a rapper","Should have pulled a sickie"]};game.resources=[{name:"title-screen",type:"image",src:"data/img/title.png"},{name:"pain-face1",type:"image",src:"data/img/face1.jpg"},{name:"pain-face2",type:"image",src:"data/img/face2.jpg"},{name:"pain-face3",type:"image",src:"data/img/face3.jpg"},{name:"pain-face4",type:"image",src:"data/img/face4.jpg"},{name:"pain-face5",type:"image",src:"data/img/face5.jpg"},{name:"pain-face1-shell",type:"image",src:"data/img/face1-shell.png"},{name:"pain-face2-shell",type:"image",src:"data/img/face2-shell.png"},{name:"pain-face3-shell",type:"image",src:"data/img/face3-shell.png"},{name:"pain-face4-shell",type:"image",src:"data/img/face4-shell.png"},{name:"pain-face5-shell",type:"image",src:"data/img/face5-shell.png"},{name:"gameover-face",type:"image",src:"data/img/gameover-face.jpg"},{name:"gameend-face",type:"image",src:"data/img/gameend-face.jpg"},{name:"temp-face",type:"image",src:"data/img/temp-face.jpg"},{name:"temp-face-inside",type:"image",src:"data/img/temp-face-inside.jpg"},{name:"temp-face-inside-shell",type:"image",src:"data/img/temp-face-inside-shell.png"},{name:"tileset1",type:"image",src:"data/img/tilesets/tileset1.png"},{name:"meta",type:"image",src:"data/img/tilesets/meta.png"},{name:"temp_man",type:"image",src:"data/img/sprites/temp-man.png"},{name:"badguy1",type:"image",src:"data/img/sprites/badguy1.png"},{name:"missile",type:"image",src:"data/img/sprites/missile.png"},{name:"face",type:"tmx",src:"data/map/face.tmx"},{name:"area_temp",type:"tmx",src:"data/map/area_temp.tmx"},{name:"area1",type:"tmx",src:"data/map/area01.tmx"},{name:"area2",type:"tmx",src:"data/map/area02.tmx"},{name:"area3",type:"tmx",src:"data/map/area03.tmx"},{name:"area4",type:"tmx",src:"data/map/area04.tmx"},{name:"area5",type:"tmx",src:"data/map/area05.tmx"},{name:"area6",type:"tmx",src:"data/map/area06.tmx"},{name:"area7",type:"tmx",src:"data/map/area07.tmx"},{name:"area8",type:"tmx",src:"data/map/area08.tmx"},{name:"music-loop",type:"audio",src:"data/bgm/",channel:1},{name:"shoot",type:"audio",src:"data/sfx/",channel:2},{name:"hitenemy",type:"audio",src:"data/sfx/",channel:2},{name:"hitplayer",type:"audio",src:"data/sfx/",channel:2},{name:"killplayer",type:"audio",src:"data/sfx/",channel:2},{name:"gasp",type:"audio",src:"data/sfx/",channel:2}],game.HUD=game.HUD||{},game.HUD.Container=me.ObjectContainer.extend({init:function(){this.parent(),this.isPersistent=!0,this.collidable=!1,this.z=1/0,this.name="HUD",this.addChild(new game.HealthBar)}}),game.HealthBar=me.Renderable.extend({init:function(){this.parent(new me.Vector2d(140,590),200,20)},draw:function(a){if("face"===me.levelDirector.getCurrentLevelId()){var b=2;a.fillStyle="red",a.fillRect(this.pos.x,this.pos.y,this.width,this.height),a.fillStyle="green",a.fillRect(this.pos.x+b,this.pos.y+b,this.width*(game.data.health/game.data.maxHealth)-2*b,this.height-2*b)}new me.Font("Verdana",30,"red").draw(a,"Wave "+game.data.waveNumber,100,50)}}),game.Badguy1Entity=me.ObjectEntity.extend({currentVel:new me.Vector2d(0,0),currentVelSetTime:me.timer.getTime(),currentVelDuration:0,worry:"",health:2,init:function(a,b,c){var d;this.parent(a,b,c),this.setVelocity(3,3),this.collidable=!0,this.type=me.game.ENEMY_OBJECT,game.worries.length&&Math.random()<.3&&(d=Math.floor(Math.random()*game.worries.length),this.worry=game.worries[d],game.worries.splice(d,1))},update:function(){return me.timer.getTime()>this.currentVelSetTime+this.currentVelDuration&&(this.currentVel=new me.Vector2d(6*Math.random()-3,6*Math.random()-3),this.currentVelSetTime=me.timer.getTime(),this.currentVelDuration=1e3*Math.random()),this.vel=this.currentVel,this.updateMovement(),0!=this.vel.x||0!=this.vel.y?(this.parent(),!0):!1},onCollision:function(a,b){if("MISSILE"===b.type&&this.health--<=1){var c=0;me.game.world.children.forEach(function(a){a.type==me.game.ENEMY_OBJECT&&c++}),1>=c&&me.event.publish("/allEnemiesDead",[]),this.collidable=!1,me.game.remove(this)}},draw:function(a){this.parent(a),new me.Font("Verdana",14,"white").draw(a,this.worry,this.pos.x-70,this.pos.y-20)}}),game.FaceEntity=me.ObjectEntity.extend({levelForWave:[],init:function(a,b,c){var d;for(c.image="temp-face",this.parent(a,b,c),this.setVelocity(0,0),d=1;10>d;d++)this.levelForWave[d]="area"+d},update:function(){me.input.isKeyPressed("start")&&me.levelDirector.loadLevel(this.levelForWave[game.data.waveNumber])}}),game.FaceLayer=game.FaceLayer||{},game.FaceLayer.Container=me.ObjectContainer.extend({faceImages:[],faceImageShells:[],init:function(){this.parent(),this.isPersistent=!0,this.collidable=!1,this.z=981239,this.name="FaceLayer",this.faceImages[5]=me.loader.getImage("pain-face1"),this.faceImages[4]=me.loader.getImage("pain-face2"),this.faceImages[3]=me.loader.getImage("pain-face3"),this.faceImages[2]=me.loader.getImage("pain-face4"),this.faceImages[1]=me.loader.getImage("pain-face5"),this.faceImageShells[5]=me.loader.getImage("pain-face1-shell"),this.faceImageShells[4]=me.loader.getImage("pain-face2-shell"),this.faceImageShells[3]=me.loader.getImage("pain-face3-shell"),this.faceImageShells[2]=me.loader.getImage("pain-face4-shell"),this.faceImageShells[1]=me.loader.getImage("pain-face5-shell")},draw:function(a){"play"===me.state.current().name&&game.data.health>0&&("face"===me.levelDirector.getCurrentLevelId()?a.drawImage(this.faceImages[game.data.health],0,0):a.drawImage(this.faceImageShells[game.data.health],0,0))}}),game.ManEntity=me.ObjectEntity.extend({previousMissileTime:me.timer.getTime(),init:function(a,b,c){this.parent(a,b,c),this.setVelocity(.4,.4),this.setMaxVelocity(3,3),me.event.subscribe("/allEnemiesDead",function(){this.levelComplete()}.bind(this))},update:function(){var a,b,c=function(a){return Math.abs(this.vel[a])<.01?0:this.vel[a]<0?this.vel[a]+=this.accel[a]*me.timer.tick:this.vel[a]>0?this.vel[a]-=this.accel[a]*me.timer.tick:void 0}.bind(this);me.input.isKeyPressed("left")?this.vel.x-=this.accel.x*me.timer.tick:me.input.isKeyPressed("right")?this.vel.x+=this.accel.x*me.timer.tick:this.vel.x=c("x"),me.input.isKeyPressed("up")?this.vel.y-=this.accel.y*me.timer.tick:me.input.isKeyPressed("down")?this.vel.y+=this.accel.y*me.timer.tick:this.vel.y=c("y"),this.updateMovement(),game.data.playerPos=this.pos;var d=me.game.collide(this);return d&&d.obj.type==me.game.ENEMY_OBJECT&&this.levelFailed(),a=me.input.isKeyPressed("shootUp")||me.input.isKeyPressed("shootDown")||me.input.isKeyPressed("shootLeft")||me.input.isKeyPressed("shootRight"),a&&me.timer.getTime()-this.previousMissileTime>250&&(this.previousMissileTime=me.timer.getTime(),me.input.isKeyPressed("shootUp")&&me.input.isKeyPressed("shootLeft")?b="upLeft":me.input.isKeyPressed("shootUp")&&me.input.isKeyPressed("shootRight")?b="upRight":me.input.isKeyPressed("shootDown")&&me.input.isKeyPressed("shootLeft")?b="downLeft":me.input.isKeyPressed("shootDown")&&me.input.isKeyPressed("shootRight")?b="downRight":me.input.isKeyPressed("shootUp")?b="up":me.input.isKeyPressed("shootDown")?b="down":me.input.isKeyPressed("shootLeft")?b="left":me.input.isKeyPressed("shootRight")&&(b="right"),me.game.add(new game.MissileEntity(this.pos.x+this.width/2,this.pos.y+this.height/2,{},b),this.z),me.audio.play("shoot"),me.game.sort()),0!=this.vel.x||0!=this.vel.y?(this.parent(),!0):!1},levelFailed:function(){me.event.publish("/levelEnd",[]),0===--game.data.health?(me.audio.play("killplayer"),me.state.change(me.state.GAMEOVER)):(me.audio.play("hitplayer"),me.game.viewport.shake(8,500,me.game.viewport.AXIS.BOTH),me.levelDirector.loadLevel("face"))},levelComplete:function(){"face"!==me.levelDirector.getCurrentLevelId()&&(me.event.publish("/levelEnd",[]),++game.data.waveNumber>8?me.state.change(me.state.GAME_END):me.levelDirector.loadLevel("face"))}}),game.MissileEntity=me.ObjectEntity.extend({init:function(a,b,c,d){c.image="missile",this.parent(a,b,c),"upLeft"===d||"upRight"===d||"downLeft"===d||"downRight"===d?this.setVelocity(4,4):this.setVelocity(8,8),this.direction=d,this.type="MISSILE",me.event.subscribe("/levelEnd",function(){me.game.remove(this)}.bind(this))},update:function(){var a,b;switch(this.direction){case"left":this.vel.x-=this.accel.x*me.timer.tick,this.vel.y=0;break;case"right":this.vel.x+=this.accel.x*me.timer.tick,this.vel.y=0;break;case"up":this.vel.x=0,this.vel.y-=this.accel.y*me.timer.tick;break;case"down":this.vel.x=0,this.vel.y+=this.accel.y*me.timer.tick;break;case"upLeft":this.vel.x-=this.accel.x*me.timer.tick,this.vel.y-=this.accel.y*me.timer.tick;break;case"upRight":this.vel.x+=this.accel.x*me.timer.tick,this.vel.y-=this.accel.y*me.timer.tick;break;case"downLeft":this.vel.x-=this.accel.x*me.timer.tick,this.vel.y+=this.accel.y*me.timer.tick;break;case"downRight":this.vel.x+=this.accel.x*me.timer.tick,this.vel.y+=this.accel.y*me.timer.tick}return a=this.updateMovement(),(0!=a.x||0!=a.y)&&(this.collidable=!1,me.game.remove(this)),b=me.game.world.collide(this),b&&b.obj.type==me.game.ENEMY_OBJECT&&(me.audio.play("hitenemy"),me.game.viewport.shake(5,100,me.game.viewport.AXIS.BOTH),this.collidable=!1,me.game.remove(this)),!0}}),game.GameEndScreen=me.ScreenObject.extend({init:function(){this.parent(!0),this.title=null},onResetEvent:function(){null==this.title&&(this.title=me.loader.getImage("gameend-face"))},update:function(){return me.input.isKeyPressed("start")&&me.state.change(me.state.PLAY),!0},draw:function(a){a.drawImage(this.title,0,0)},onDestroyEvent:function(){me.input.unbindKey(me.input.KEY.ENTER)}}),game.GameOverScreen=me.ScreenObject.extend({init:function(){this.parent(!0),this.title=null},onResetEvent:function(){null==this.title&&(this.title=me.loader.getImage("gameover-face")),this.timeDied=me.timer.getTime(),me.audio.stopTrack()},update:function(){return me.input.isKeyPressed("start")&&me.timer.getTime()>this.timeDied+2e3&&me.state.change(me.state.PLAY),!0},draw:function(a){a.drawImage(this.title,0,0)},onDestroyEvent:function(){me.input.unbindKey(me.input.KEY.ENTER)}}),game.PlayScreen=me.ScreenObject.extend({name:"play",onResetEvent:function(){game.data.maxHealth=5,game.data.health=5,game.data.waveNumber=1,me.audio.playTrack("music-loop",.5),me.levelDirector.loadLevel("area1"),this.HUD=new game.HUD.Container,me.game.world.addChild(this.HUD),this.FaceLayer=new game.FaceLayer.Container,me.game.world.addChild(this.FaceLayer)},onDestroyEvent:function(){me.game.world.removeChild(this.HUD)}}),game.TitleScreen=me.ScreenObject.extend({init:function(){this.parent(!0),this.title=null},onResetEvent:function(){null==this.title&&(this.title=me.loader.getImage("title-screen"))},update:function(){return me.input.isKeyPressed("start")&&me.state.change(me.state.PLAY),!0},draw:function(a){a.drawImage(this.title,0,0)},onDestroyEvent:function(){me.input.unbindKey(me.input.KEY.ENTER)}});