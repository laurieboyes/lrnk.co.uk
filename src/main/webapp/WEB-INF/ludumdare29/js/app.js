...
game.resources = [
    ...
    //pain face shells
    {name: "pain-face1-shell", type: "image", src: "data/img/face1-shell.png"},
    {name: "pain-face2-shell", type: "image", src: "data/img/face2-shell.png"},
    {name: "pain-face3-shell", type: "image", src: "data/img/face3-shell.png"},
    {name: "pain-face4-shell", type: "image", src: "data/img/face4-shell.png"},
...
game.MissileEntity = me.ObjectEntity.extend({
    ...
    update: function () {
        ...
        if (collideRes && (collideRes.obj.type == me.game.ENEMY_OBJECT)) {
            ...
            me.game.viewport.shake(5, 100, me.game.viewport.AXIS.BOTH);
            this.collidable = false;
            me.game.remove(this);
        }
...
game.GameEndScreen = me.ScreenObject.extend({
	...
	onResetEvent: function() {
        if (this.title == null) {
            this.title = me.loader.getImage("gameend-face");
        }        
	},
